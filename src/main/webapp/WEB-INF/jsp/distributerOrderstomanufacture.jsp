...
<%@page import="neu.edu.controller.model.DistributerOrders"%>
...
<body>
	...
	<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
		...
		<div align="center">
		<form   action="orderacceptbymanufacture" method="post" class="Form">
		<%if(request.getAttribute("error")!= null){%>
			...
			<thead>
				...
				<%
				for(DistributerOrders order : (ArrayList<DistributerOrders>) request.getAttribute("distributerOrders"))
						{
				%>
				<tr>
		...
		<form action="getbacksupplydashboard"  method="post" class="Form">
