...
<%@page import="neu.edu.controller.model.DistributerProduct"%>
...
<body>
	...
	<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
		...
		<div align="center">
		<form   action="getbackdistributermanagerdashboard" method="post" class="Form">
			...
			<thead>
				...
				<%
				for(DistributerProduct item : (ArrayList<DistributerProduct>) request.getAttribute("product"))
						{
				%>
				<tr>
			...
			<input type ="hidden" id="distributerid" name= "distributerid" value="<%=request.getAttribute("comp")%>"/>
			<br>
			<br>
			<br>
			<br>
