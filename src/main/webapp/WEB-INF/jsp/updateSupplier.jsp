...
<body>
	<div class="w3-container w3-light-grey" style="padding: 28px 16px"
		...
		<div style="margin-top: 48px">
			<form action="updatesupplierr" method="post">
			<% 
			SupplierController supplier = (SupplierController) request.getAttribute("supplier");
			%>
				<p>
					<label>Supplier ID</label>
					<input  readonly="readonly" class="w3-input w3-border" type="text"
						  name="supplierid"  value="<%=supplier.getSupplierid()%>" >
				</p>
