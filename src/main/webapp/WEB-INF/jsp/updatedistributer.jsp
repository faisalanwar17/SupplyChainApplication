...
<body>
	<div class="w3-container w3-light-grey" style="padding: 28px 16px"
		...
		<div style="margin-top: 48px">
			<form action="updatedistributerer" method="post">
			<% 
			Distributer supplier = (Distributer) request.getAttribute("distributer");
			%>
				<p>
					<label>Manufacture ID</label>
					<input  readonly="readonly" class="w3-input w3-border" type="text"
						  name="distributerid"  value="<%=supplier.getDistributerid()%>" >
				</p>
